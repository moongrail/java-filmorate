...
public class FilmServiceImpl implements FilmService {
    ...
    public List<Film> getCommonFilms(Long userId, Long friendId) {
        ...
        List<Long> friendFilmsIds = friendFilms.stream().map(Film::getId).collect(Collectors.toList());
        return userFilms.stream().filter(x -> friendFilmsIds.contains(x.getId())).collect(Collectors.toList());
    }
